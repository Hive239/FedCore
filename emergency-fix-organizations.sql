-- EMERGENCY FIX for Organizations Table Issue
-- Run this immediately in Supabase SQL Editor

-- Drop existing organizations table/view if it exists
...
SELECT 
    ...
    'Emergency fix complete - organizations table created' as status
